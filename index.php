            ...
            this.getReport = function() {
                $.ajax({
                    ...
                    $.getJSON('./log_report_folder/profitandlossresults.json', function(result) {
                      ...
                      const entries = Object.entries(rowArray);
                      console.log(entries);
...
<div class="container">
    ...
    <p>If there is no access token or the access token is invalid, click either the <b>Connect to QucikBooks</b> button above.</p>
    <pre id="classInfo"></pre>
    <button  type="button" class="btn btn-success" onclick="apiCall.getClassInfo()">Get Class Info</button>

    <hr />

    <h2>Get Report Info</h2>
    <p>If there is no access token or the access token is invalid, click either the <b>Connect to QucikBooks</b> button above.</p>
    <pre id="report"></pre>
    <button  type="button" class="btn btn-success" onclick="apiCall.getReport()">Get Report Info</button>
    <pre id="csv"></pre>
